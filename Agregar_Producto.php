                    ...
                    <div id="page-right-content">
                        ...
                        <div class="col-lg-20">
                            <div class="p-20 m-b-20">
                                ...
                                <div class="p-20 m-b-20">
                                    <form role="form" class="form-validation" autocomplete="off" action="PHP/nuevoProducto.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label for="hori-pass1" class="col-sm-4 form-control-label">Precio<span class="text-danger">*</span></label>
                                            <div class="col-sm-7">
                                                <input id="hori-pass1" type="text" placeholder="Ingrese Precio" name="precio" 
                                                       class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="webSite" class="col-sm-4 form-control-label">Cantidad<span class="text-danger">*</span></label>
                                            <div class="col-sm-7">
                                                <input class="form-control"
                                                       name="cantidad" placeholder="Ingrese Cantidad" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <select class="form-control select2" name="provedor">
                                                    <option>Elija Un Proveedor</option>
                                                    <?php
                                                    include 'PHP/conexion.php';

                                                    $sql = "SELECT * FROM provedor";
                                                    $stmt = mysqli_query($conn,$sql) or die ("error en la consulta provedor");

                                                    while($row = mysqli_fetch_array($stmt))
                                                    {
                                                        echo "<option value=".$row['id_provedor'].">".$row['nombre']."</option>";
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            <label for="webSite" class="col-sm-4 form-control-label">Categoría<span class="text-danger">*</span></label>
                                            <div class="col-sm-7">
                                                ...
                                                <select class="form-control select2" name="categoria">
                                                    ...
                                                    $stmt = mysqli_query($conn,$sql) or die ("error en la consulta categoria");
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="p-20 m-b-20">
                                                    ...
                                                    <textarea name="descripcion" class="summernote" placeholder="Ingrese Descripción">
