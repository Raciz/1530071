                            ...
                            <div class="col-sm-12">
                                <div class="m-b-20 table-responsive">
                                    ...
                                    <table id="datatable-fixed-col" class="table table-striped table-bordered">
                                        ...
                                        $sql = "SELECT pr.nombre as nom, pr.precio as prec, pr.cantidad as cant, pr.descripcion as descr, p.nombre as prov FROM provedor p INNER JOIN productos pr ON pr.id_provedor = p.id_provedor";
