                                ...
                                <div class="tab-pane active" id="local">
                                    <div class="col-lg-20">
                                        <div class="p-20 m-b-20">
                                            ...
                                            <h4 class="header-title m-t-0">Registro De Venta</h4>
                                            <div class="p-20 m-b-20">
                                                <form role="form" class="form-validation" action="PHP/ventaLocal.php" method="post">
                                ...
                                <div class="tab-pane" id="domicilio">
                                    <div class="col-lg-20">
                                        <div class="p-20 m-b-20">
                                            ...
                                            <h4 class="header-title m-t-0">Registro De Venta A Domicilio</h4>
                                            <div class="p-20 m-b-20">
                                                <form role="form" class="form-validation" action="PHP/ventaLocal.php" method="post">
