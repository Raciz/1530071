...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Agregar Categoría - SuKarne</title>
                    ...
                    <div id="page-right-content">
                        ...
                        <div class="col-lg-20">
                            <div class="p-20 m-b-20">
                                <h4 class="header-title m-t-0">Agregar Categoría</h4>
                                <div class="p-20 m-b-20">
                                    <form role="form" class="form-validation" autocomplete="off" action="PHP/nuevaCategoria.php" method="post">
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-4 form-control-label">Nombre<span class="text-danger">*</span></label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="nombre" placeholder="Ingrese Nombre De La Categoria" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="p-20 m-b-20">
                                                    <h4 class="m-b-30 m-t-0 header-title">Descripcíon</h4>
                                                    <textarea required name="descripcion" class="summernote" placeholder="Ingrese Descripcion">
