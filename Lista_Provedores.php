...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Registro De Provedores - SuKarne</title>
                                ...
                                <div class="m-b-20 table-responsive">
                                    ...
                                    <table id="datatable-fixed-col" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM provedor p INNER JOIN productos pr ON pr.id_provedor = p.id_provedor";
                                            ...
                                            while($row = mysqli_fetch_array($stmt))
                                            {
                                                echo "<tr>
                                                    <td>".$row['p.nombre']."</td>
                                                    <td>".$row['p.precio']."</td>
                                                    <td>".$row['p.cantidad']."</td>
                                                    <td>".$row['p.descripcion']."</td>
                                                    <td>".$row['pr.provedor']."</td>
                                                </tr>";
                                            }
                                            ?>
                                        </tbody>
